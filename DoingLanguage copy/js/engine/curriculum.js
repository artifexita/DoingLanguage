...
export const CURRICULUM = [
  {
    ...
    name: 'Foundations',
    icon: '🔤',
    description: 'Letters, numbers, and punctuation — the building blocks',
    locked: false,
    subtiers: [
      {
        id: '1.1',
        name: 'Uppercase Letters',
        description: 'Recognise and name the 26 uppercase letters A–Z',
        dataFile: 'data/tier1/letters.json',
        exerciseTypes: [
          { type: 'multiple-choice', name: 'Identify the Letter', icon: '🎯', description: 'Hear a letter name, choose the correct letter' },
          { type: 'listen-repeat', name: 'Say the Letter', icon: '🗣️', description: 'See a letter, say its name aloud' },
        ],
      ...
      },
      {
        ...
        description: 'Recognise lowercase letters and match to uppercase',
        dataFile: 'data/tier1/letters.json',
        exerciseTypes: [
          { type: 'multiple-choice', name: 'Identify the Letter', icon: '🎯', description: 'Hear a letter name, choose the correct lowercase letter' },
          { type: 'match-pairs', name: 'Match Upper & Lower', icon: '🔗', description: 'Match uppercase letters to their lowercase form' },
        ],
        getItemDisplay: (item) => item.lower,
        getItemLabel: (item) => item.name,
        getItemSpeech: (item) => item.lower,
      },
      {
        id: '1.3',
        name: 'Letter Sounds',
        description: 'Learn the sounds each letter makes (phonemes)',
        ...
        getItemSpeech: (item) => item.examples?.initial?.word || '',
      },
      {
        id: '1.4',
        name: 'Numbers 0–100',
